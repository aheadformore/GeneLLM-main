...
class ModelConfig(BaseConfig):
    ...
    moe: bool = False
    """
    If ``True``, use mixture of experts.
    """
...
class TrainConfig(BaseConfig):
    ...
    """
    The path to the ancestor model checkpoint.
    """

    tuckered_ancestor_path: Optional[str] = None
    """
    The path to the tuckered ancestor model checkpoint.
    """

    distll: bool = False
    """
    If ``True``, use distillation.
    """
    ...
    distributed_strategy: Optional[DistributedStrategy] = DistributedStrategy.ddp
    """
